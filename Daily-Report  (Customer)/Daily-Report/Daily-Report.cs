    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (File.ReadAllText("../../PathFile.txt") != "")
            {
                ...
                if (day < 10)
                {
                    txtOutputPath.Text = getPathOutput + "\\Rpt-0" + day.ToString() + "-" + dt.ToString("MMM") + "-" + dt.ToString("yyyy") + " (Customer).xls";
                }
                else
                {
                    txtOutputPath.Text = getPathOutput + "\\Rpt-" + day.ToString() + "-" + dt.ToString("MMM") + "-" + dt.ToString("yyyy") + " (Customer).xls";
                }
            }
        }
